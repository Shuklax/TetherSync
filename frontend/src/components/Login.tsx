  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col justify-center bg-[#0b0b0b] px-5 h-130 w-100 rounded-2xl border-1 border-emerald-800">
        ...
        <div>
          <button className="text-black bg-green-400 rounded-lg w-full h-8 font-semibold">Sign In</button>
        </div>
        <div className="text-white opacity-50 mt-3">
            Don't have an account?<span className="hover:underline"> Sign Up</span>
        </div>
        <div className="text-white bg-[#161616] p-2 rounded-2xl text-[13px] mt-6">
            <p className="opacity-50 mb-2">Demo Accounts: </p>
            <p>Admin: admin@tethersync.com / admin123</p>
            <p>Moderator: mod@tethersync.com / mod123</p>
            <p>User: user@tethersync.com / user123</p>
